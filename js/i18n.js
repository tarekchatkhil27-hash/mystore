...
const translations = {
  en: {
    ...
    copy_code:          "Copy Code",
    code_copied:        "Copied!",
    delivery_info_text: "We deliver within 1–3 business days. Free delivery on orders above ৳500. Delivery charge ৳60 for orders below ৳500.",
    return_policy_text: "Items can be returned within 3 days of delivery if they are unused and in original condition. Contact us via WhatsApp to initiate a return.",
    ...
    about_story_p1:     "Smart Supper Shop was founded with a simple mission — to bring fresh, quality products to every home at the best possible prices. From groceries to textiles, we carefully select every item we sell.",
    about_story_p2:     "We believe shopping should be easy, affordable, and trustworthy. With fast delivery and friendly service, we are your neighbourhood store — just online.",
  ...
  bn: {
    ...
    delivery_info_text: "আমরা ১–৩ কার্যদিবসের মধ্যে ডেলিভারি দিই। ৳৫০০ এর উপরে অর্ডারে বিনামূল্যে ডেলিভারি। ৳৫০০ এর নিচে ডেলিভারি চার্জ ৳৬০।",
    return_policy_text: "ডেলিভারির ৩ দিনের মধ্যে অব্যবহৃত ও অক্ষত অবস্থায় পণ্য ফেরত দেওয়া যাবে। ফেরতের জন্য হোয়াটসঅ্যাপে যোগাযোগ করুন।",
    ...
    about_story_p1:     "স্মার্ট সুপার শপ একটি সহজ লক্ষ্য নিয়ে যাত্রা শুরু করেছে — সেরা দামে তাজা ও মানসম্পন্ন পণ্য প্রতিটি ঘরে পৌঁছে দেওয়া। মুদিখানা থেকে বস্ত্র, আমরা প্রতিটি পণ্য সযত্নে বাছাই করি।",
    about_story_p2:     "আমরা বিশ্বাস করি কেনাকাটা হওয়া উচিত সহজ, সাশ্রয়ী এবং বিশ্বস্ত। দ্রুত ডেলিভারি ও বন্ধুত্বপূর্ণ সেবায় আমরা আপনার পাড়ার দোকান — শুধু অনলাইনে।",
...
(function loadFonts() {
  ...
  link.id = fontId;
  link.rel = 'stylesheet';
  link.href = 'https://fonts.googleapis.com/css2?family=Tiro+Bangla:ital@0;1&family=Times+New+Roman&display=swap';
...
function t(key, vars, forceLang) {
  ...
  let str = (translations[lang] && translations[lang][key])
    ...
    : (translations['en'][key] || key); // fallback to English, then key itself
